...
var pd = PixelData.fromImage("sheet.png")
...
for(layer in 0...8){
  pd = PixelData.create(3,3)
  pd.set(0,0,tiles[layer])
  pd.set(1,0,tiles[layer])
  pd.set(2,0,tiles[layer])
  pd.set(0,1,tiles[layer])
  pd.set(0,2,tiles[layer])
...
while(true){
  Layer.transform(0,0,0,x/100)
  Layer.transform(1,0,0,x/75)
  Layer.transform(2,0,0,x/50)
  Layer.transform(3,0,0,x/25)
  Layer.transform(4,0,0,-x/100)
  Layer.transform(5,0,0,-x/75)
  Layer.transform(6,0,0,-x/50)
  Layer.transform(7,0,0,-x/25)
  x = x + 0.5
  y = y + 0.5
  Fiber.yield()
}